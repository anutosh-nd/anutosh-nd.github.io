...
---
//[Netradyne Driveri SDK](../../index.md)/[com.netradyne.driverisdk.events](../index.md)/[EventVideoStatus](index.md)



# EventVideoStatus  
 [common] class [EventVideoStatus](index.md)

This class represents possible states on an event video
...
|  Name|  Summary| 
|---|---|
| <a name="com.netradyne.driverisdk.events/EventVideoStatus/EventVideoStatus/#/PointingToDeclaration/"></a>[EventVideoStatus](-event-video-status.md)| <a name="com.netradyne.driverisdk.events/EventVideoStatus/EventVideoStatus/#/PointingToDeclaration/"></a> [common] fun [EventVideoStatus](-event-video-status.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.netradyne.driverisdk.events/EventVideoStatus.Companion///PointingToDeclaration/"></a>[Companion](-companion/index.md)| <a name="com.netradyne.driverisdk.events/EventVideoStatus.Companion///PointingToDeclaration/"></a>[common]  <br>Content  <br>object [Companion](-companion/index.md)  <br><br><br>
